...
public class WarnaTest extends AppCompatActivity {
    public static String[] warna = {"Pink","Merah","Jingga","Kuning","Hijau","Biru","Ungu","Putih","Abu - abu","Hitam"};
            ...
            public void onClick(View v) {
                ...
                if(soal.equals(jawaban)){
                    ...
                    if(nomor_soal == jumlah_soal ){
                        Intent mainIntent;
                        mainIntent = new Intent(WarnaTest.this,HasilTest.class);
                        ...
                        storageedit.apply();
                        Intent mainIntent;
                        mainIntent = new Intent(WarnaTest.this,WarnaTest.class);
                        startActivity(mainIntent);
                        finish();
                    }
                }else{
