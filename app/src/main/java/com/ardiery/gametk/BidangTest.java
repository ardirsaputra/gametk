...
public class BidangTest extends AppCompatActivity {
    public static String[] warna = {"Persegi Panjang","Persegi","Segitiga","Segilima","Layang - Layang","Lingkaran","Trapesium","Ketupat","Lonjong","SegiEnam"};
            ...
            public void onClick(View v) {
                ...
                if(soal.equals(jawaban)){
                    ...
                    if(nomor_soal == jumlah_soal ){
                        Intent mainIntent;
                        mainIntent = new Intent(BidangTest.this,HasilTest.class);
                        ...
                        storageedit.apply();
                        Intent mainIntent;
                        mainIntent = new Intent(BidangTest.this,BuahTest.class);
                        startActivity(mainIntent);
                        finish();
                    }
                }else{
